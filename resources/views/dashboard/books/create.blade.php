...
<div class="max-w-2xl mx-auto px-4 py-10">
    ...
    <form action="{{ route('dashboard.books.store') }}" method="POST" class="bg-paper border border-line p-6 space-y-5">
        @csrf
        ...
        <div>
            ...
            <textarea name="description" rows="4" class="w-full border border-line rounded-sm px-3 py-2 bg-white">{{ old('description') }}</textarea>
