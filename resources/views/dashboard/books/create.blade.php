...
<div class="max-w-2xl mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Add a new book</h1>

    <form action="{{ route('dashboard.books.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-5">
        @csrf
        ...
        <div class="flex justify-end gap-3 pt-2">
            ...
            <button type="submit" class="bg-blue-600 text-white px-5 py-2 rounded-lg">Save book</button>
        </div>
    </form>
</div>
@endsection